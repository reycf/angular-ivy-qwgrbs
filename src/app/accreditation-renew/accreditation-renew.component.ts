...
@Component({
  selector: 'accreditation-renew',
  templateUrl: './accreditation-renew.component.html',
  styleUrls: ['./accreditation-renew.component.scss']
})
export class AccreditationRenewComponent  {
