...
@Component({
  selector: 'app-permission-detail-mobile',
  templateUrl: './permission-detail-mobile.component.html',
  styleUrls: ['./permission-detail-mobile.component.scss']
})
export class PermissionDetailMobile  {
